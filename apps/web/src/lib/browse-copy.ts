...
export const browseCopy: Record<Locale, Record<BrowseKey, string>> = {
  en: {
    ...
    partnerWithUs: "Guide with Mshwar",
    ...
    noChargeNote: "Nothing is reserved here — Mshwar builds the day, you turn up.",
    stopsLabel: "stops",
    ...
    bookingPanelTitle: "Plan this place",
  ...
  ar: {
    ...
    noChargeNote: "لا حجز هنا — مشوار يبني اليوم وأنت تحضر.",
    stopsLabel: "محطات",
    ...
    bookingPanelTitle: "خطّط لهذا المكان",
  ...
  fr: {
    ...
    partnerWithUs: "Guider avec Mshwar",
    ...
    noChargeNote: "Rien n’est réservé ici — Mshwar construit la journée, vous vous présentez.",
    stopsLabel: "étapes",
    ...
    bookingPanelTitle: "Planifier ce lieu",
