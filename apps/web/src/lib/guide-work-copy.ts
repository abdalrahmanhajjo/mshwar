...
export const guideWorkCopy: Record<Locale, Record<GuideWorkKey, string>> = {
  en: {
    ...
    tourRoutePlaceholder: "Place handle, e.g. byblos-citadel",
  ...
  ar: {
    ...
    tourRoutePlaceholder: "معرّف المكان، مثل byblos-citadel",
  ...
  fr: {
    ...
    tourRoutePlaceholder: "Identifiant du lieu, ex. byblos-citadel",
