  ...
  return (
    <LocaleLink href={`/destinations/${destination.slug}`} aria-label={destination.name} className="group block">
      <article className="relative overflow-hidden rounded-card">
        ...
        <DirectionalIcon icon={ArrowUpRight} className="absolute end-4 top-4 size-5 text-brand-foreground" />
        <div className="absolute inset-x-0 bottom-0 p-5 text-brand-foreground">
          ...
          <h3 className="mt-1 text-heading font-semibold tracking-tight">
