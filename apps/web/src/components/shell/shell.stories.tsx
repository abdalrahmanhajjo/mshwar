...
export const Business1440: Story = {
  name: "Business 1440",
  globals: { theme: "light", direction: "ltr" },
  parameters: { viewport: { defaultViewport: "desktop1440" } },
  render: () => (
...
export const Business390: Story = {
  name: "Business 390",
  globals: { theme: "light", direction: "ltr" },
  parameters: { viewport: { defaultViewport: "mobile390" } },
  render: () => (
  ...
  render: () => (
    <Frame>
      <AdminShell currentPath="/admin" auth={{ status: "signed-in", name: "Operator" }}>
        <ShellPage title="Overview" description="Admin console sidebar at 1440px." />
      </AdminShell>
    </Frame>
  ),
};

export const Admin390: Story = {
  name: "Admin 390",
  globals: { theme: "dark", direction: "ltr" },
  parameters: { viewport: { defaultViewport: "mobile390" } },
  render: () => (
    <Frame>
      <AdminShell currentPath="/admin" auth={{ status: "signed-in", name: "Operator" }}>
        <ShellPage title="Overview" description="Admin console collapses to a sheet below lg." />
      </AdminShell>
    </Frame>
  ),
};
